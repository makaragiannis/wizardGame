...
public class Controller {
	...
	void setCPUNames() {
		...
		if (playersNum > 3)  CPUNames.add(player4Name.getText());
		if (playersNum > 4)  CPUNames.add(player5Name.getText());
		if (playersNum == 6) CPUNames.add(player6Name.getText());
	}
	...
	public int getPlayersNum() {
		...
		if (threePlayers.isSelected()) playersNum = 3;
		else if (fourPlayers.isSelected()) playersNum = 4;
		else if (fivePlayers.isSelected()) playersNum = 5;
		else playersNum = 6;
